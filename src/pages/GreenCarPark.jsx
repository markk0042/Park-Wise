...
export default function GreenCarPark() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-slate-50 p-3 md:p-8">
      <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
        <div className="mb-4 md:mb-6 text-center">
          ...
          <p className="text-sm md:text-base text-slate-600 mt-2">
            Quick registration for Green permit holders
          </p>
        </div>

        <QuickRegistrationLogWithSection section="Green" />
      </div>
    </div>
  );
}